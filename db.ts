...
const dbTemplate = {
    ...
    foundFlights: false,
    flight: null as { airline: string; flightNumber: string; departure: string; arrival: string; departureTime: string; arrivalTime: string; bookingReference: string; flightDuration: string; flightTerminal: string } | null
}
